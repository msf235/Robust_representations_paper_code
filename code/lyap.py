...
def getSpectrum(W, b, Win=0, x=0, k_LE=None, max_iters=1000, tol=1e-3, max_ICs=10, ICs=None, verbose=False):
    ...
    iter_cc = utils.CheckConvergence(memory_length=10, tolerance=.1*tol)
    IC_cc = utils.CheckConvergence(memory_length=None, tolerance=tol, min_length=4)
